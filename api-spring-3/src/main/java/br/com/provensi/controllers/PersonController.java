...
import br.com.provensi.services.PersonServices;
import br.com.provensi.util.MediaType;
	...
	@Operation(
			summary = "Finds All People",
				...
				responses = {
						...
						@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
						@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content), })
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByPage(
		...
		return ResponseEntity.ok(service.findAllPeople(pageable));
	}

	@GetMapping(
			value = "/findsPeopleByFirstName/{firstName}",
			produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	@Operation(
			summary = "Finds People By FirstName",
			description = "Finds People By FirstName",
			tags = { "People" },
			responses = {
					@ApiResponse(
							description = "Success",
...
//	}
	...
	@PatchMapping(
			value = "/{id}",
				produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML })
	@Operation(
			summary = "Disable a specific a Person By Id",
				description = "Disable a specific a Person By Id",
				tags = { "People" },
				responses = {
						@ApiResponse(
								description = "Success",
