package br.com.provensi.integrationtests.repositories;
...
public class PersonRepositoryTest extends AbstractIntegrationTest {
	...
	public void testFindByFirstName() throws JsonMappingException, JsonProcessingException {
		...
		person = personRepository.findPeopleByFirstName("adrea", pageable).getContent().get(0);
		...
		assertEquals(583, person.getId());

		assertEquals("Adrea", person.getFirstName());
		assertEquals("De Lorenzo", person.getLastName());
		assertEquals("2274 Ohio Terrace", person.getAddress());
